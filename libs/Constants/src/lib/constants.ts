...
export const PASSWORD_RESET_OTP_EXPIRY_SECONDS = 300; // 5 minutes
export const RATE_LIMIT_COOLDOWN_SECONDS = 60; // 60 seconds
export const BRUTE_FORCE_LOCKOUT_SECONDS = 900; // 15 minutes
export const EMERGENCY_FREEZE_LOCKOUT_SECONDS = 86400; // 24 hours
